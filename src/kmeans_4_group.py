...
def kmeans_group( latency_matrix, output_path, num_groups=4 ):
    """
    使用 KMeans 算法将节点分成 num_groups 组
    :param latency_matrix: 时延矩阵
    :param output_path: 输出路径
    :param num_groups: 需要划分的组数，默认是 4
    """
...
def main():
    ...
    # 如果没有提供 num_groups 参数，默认设置为 4 组
    # 修改这里可以修改得到 k = x 参数
    num_groups = int(sys.argv[3]) if len(sys.argv) > 3 else 4
