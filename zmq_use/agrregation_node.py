    ...
    try:
        while True:
            try:
                ...
                print(f"Error receiving message from normal node: {e}")
    finally:
        pull_socket.close()
        context.term()
    ...
    try:
        while True:
            ...
            try:
                ...
                print(f"Error publishing message to other aggregation nodes: {e}")
    finally:
        pub_socket.close()
        context.term()
    ...
    try:
        while True:
            try:
                ...
                print(f"Error receiving message from other aggregation node: {e}")
    # 清理
    finally:
        sub_socket.close()
        context.term()
